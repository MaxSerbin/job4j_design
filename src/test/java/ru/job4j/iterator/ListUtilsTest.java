...
public class ListUtilsTest {
    ...
    public void whenRemoveIf() {
        List<Integer> input = new ArrayList<>(Arrays.asList(0, 1, 2));
        Predicate<Integer> filter = a -> a == 2;
    ...
    public void whenReplaceIf() {
        ...
        Predicate<Integer> filter = a -> a < 3;
        ListUtils.replaceIf(input, filter, 7);
        assertThat(Arrays.asList(7, 7, 7, 3), Is.is(input));
    }

    @Test
    public void whenRemoveAll() {
        List<Integer> input = new ArrayList<>(Arrays.asList(0, 1, 2, 3));
        List<Integer> el = new ArrayList<>(Arrays.asList(7, 1, 2, 3));
